...
class ContactosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contacto" do
    assert_difference('Contacto.count') do
      post contactos_url, params: { contacto: { budget: @contacto.budget, email: @contacto.email, name: @contacto.name, phone: @contacto.phone, service_type: @contacto.service_type, stage: @contacto.stage, start: @contacto.start, timeframe: @contacto.timeframe } }
    end
  ...
  test "should update contacto" do
    patch contacto_url(@contacto), params: { contacto: { budget: @contacto.budget, email: @contacto.email, name: @contacto.name, phone: @contacto.phone, service_type: @contacto.service_type, stage: @contacto.stage, start: @contacto.start, timeframe: @contacto.timeframe } }
